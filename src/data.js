export const discoveryData = {
  herbs: [
    ...
    { name: "Turmeric", benefit: "Turmeric contains curcumin, which is widely known for its strong anti-inflammatory effects.", icon: "Sun", image: "https://images.unsplash.com/photo-1615485925600-97237c4fc1ec?auto=format&fit=crop&w=400&q=80", tags: ["inflammation", "immunity", "spice"], vid: "https://www.youtube.com/watch?v=vVj44t_qIks" },
    ...
    { name: "Moringa (Shiferaw)", benefit: "Ethiopian superfood rich in vitamins, minerals, and antioxidants. Great for energy.", icon: "TreePine", image: "https://images.unsplash.com/photo-1607595561334-039cfa6db098?auto=format&fit=crop&w=400&q=80", tags: ["ethiopian", "energy", "superfood"], vid: "https://www.youtube.com/watch?v=J3-R0f_tDxc" },
    ...
    { name: "Koso", benefit: "Traditional Ethiopian medicinal plant known for anti-parasitic properties.", icon: "TreePine", image: "https://images.unsplash.com/photo-1473448912268-2022ce9509d8?auto=format&fit=crop&w=400&q=80", tags: ["ethiopian", "cleansing", "traditional"] }
  ],
  foods: [
