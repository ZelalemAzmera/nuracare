export const discoveryData = {
  herbs: [
    { name: "Ashwagandha", benefit: "Helps the body manage stress and reduce anxiety.", icon: "Leaf", image: "https://images.unsplash.com/photo-1596560548464-f010549b84d7?auto=format&fit=crop&w=400&q=80", tags: ["stress", "sleep", "ayurveda"] },
    ...
    { name: "Moringa (Shiferaw)", benefit: "Ethiopian superfood rich in vitamins, minerals, and antioxidants. Great for energy.", icon: "TreePine", image: "https://images.unsplash.com/photo-1621245840656-74fcba922c06?auto=format&fit=crop&w=400&q=80", tags: ["ethiopian", "energy", "superfood"], vid: "https://www.youtube.com/watch?v=J3-R0f_tDxc" },
